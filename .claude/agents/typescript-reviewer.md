...
For deeper React-specific patterns (hooks discipline, Server/Client Component boundaries, Suspense, accessibility-first composition), cross-check against the `react-patterns` skill — it auto-loads for `.tsx`/`.jsx` files.
