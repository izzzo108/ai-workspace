...
- Run `axe` (e.g. `jest-axe` or `@axe-core/playwright`) in component tests
...
- Skills: [frontend-patterns](../frontend-patterns/SKILL.md) for cross-framework UI concerns, [vite-patterns](../vite-patterns/SKILL.md) for the Vite build layer
- Agents: `@typescript-reviewer` for code review, `@build-error-resolver` for build/bundler errors
