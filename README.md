...
| Скрипты план-ревью и мозгового штурма (Claude / Codex / GLM) | [scripts.md](./docs/harness/scripts.md) |
...
├── scripts/          — план-ревью и мозговой штурм (Claude/Codex/GLM), см. docs/harness/scripts.md
