...
#   1. Бриф: задача (обязательно) + необязательные уточнения (Enter — пропустить)
#      + имя папки с результатами (обязательно).
#   2. Для каждого из трёх слотов выбираешь движок, модель и глубину размышления:
#        - НАЧИНАЮЩИЙ  (предлагает идеи),
#        - ОТВЕЧАЮЩИЙ  (критикует / оппонирует),
#        - ПОДВОДЯЩИЙ ИТОГИ (оформляет итог красивой HTML-страницей).
...
#   5. Подводящий итоги всегда выдаёт итог как красивую самодостаточную HTML-страницу
...
# ---------------------------------------------------------------------------
# Папка-сессия: docs/brainstorm/<ваше-имя>_ДД_ММ_ГГГГ/
# ---------------------------------------------------------------------------
...
# --- Подведение итогов + результат всегда красивой HTML-страницей -----------
